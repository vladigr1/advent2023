...
// configuration step. It creates a namespace called `advent2023`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", advent2023::cmake::project_name, advent2023::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", advent2023::cmake::project_version);
      return EXIT_SUCCESS;
    }
